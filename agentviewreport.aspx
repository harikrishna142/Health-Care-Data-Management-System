<%@ Page Title="" Language="C#" MasterPageFile="~/Agent.master" AutoEventWireup="true" CodeFile="agentviewreport.aspx.cs" Inherits="agentviewreport" %>
...
<tr><td>Search Detail By ID:</td><td><asp:TextBox ID="txtpatid" runat="server"></asp:TextBox></td><td>
    ...
    <tr>
        <td>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [tdate], [ttime], [pid], [pname], [docname], [hosname], [hosloc], [dises], [type], [symp], [medi], [descrip], [tn1], [tr1], [tn2], [tr2], [tn3], [tr3], [tn4], [tr4], [tn5], [tr5], [tn6], [tr6], [labasid], [nurseremarks], [nurseid], [tid] FROM [treatment]"></asp:SqlDataSource>
            <%--<asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                DataFile="~/App_Data/phrdb.mdb" 
                SelectCommand="SELECT [tdate], [ttime], [pid], [pname], [docname], [hosname], [hosloc], [dises], [type], [symp], [medi], [descrip], [tn1], [tr1], [tn2], [tr2], [tn3], [tr3], [tn4], [tr4], [tn5], [tr5], [tn6], [tr6], [labasid], [nurseremarks], [nurseid], [tid] FROM [treatment]">
            </asp:AccessDataSource>--%>
            
        </td>
    </tr>
</table>
<table style="height: 423px; width: 1144px">
    <tr>
