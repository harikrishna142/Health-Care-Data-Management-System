<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="createnurse.aspx.cs" Inherits="createnurse" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="height: 443px; width: 600px; margin-right: 0px;" >
          <tr>
        <td style="color: #CC00CC; text-decoration: underline;" valign="bottom">
            NURSE&nbsp; CREATION:  
            <asp:Image ID="Image1" runat="server" Height="40px" 
                ImageUrl="~/img/n1.png" Width="48px" />
        </td>
    </tr>
<tr><td>Nurse ID:</td><td>
...
<tr><td>&nbsp;</td><td>
    ...
    <table>
        <tr>
            <td>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" Width="816px" DataKeyNames="nurseid" OnRowDeleting="GridView1_RowDeleting" OnRowUpdating="GridView1_RowUpdating">
                    <AlternatingRowStyle BackColor="#DCDCDC" />
                    <Columns>
                        <asp:TemplateField HeaderText="Nurse Id" SortExpression="nurseid">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("nurseid") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label9" runat="server" Text='<%# Bind("nurseid") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Name" SortExpression="nursename">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("nursename") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("nursename") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [nurseid], [nursename], [age], [gender], [yrexp], [phno], [email], [uname], [pwd] FROM [nursedet]"></asp:SqlDataSource>
