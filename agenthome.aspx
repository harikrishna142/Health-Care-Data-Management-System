<%@ Page Title="" Language="C#" MasterPageFile="~/Agent.master" AutoEventWireup="true" CodeFile="agenthome.aspx.cs" Inherits="agenthome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <td></td>
    ...
    <table align="center">
        <tr>
            <td>
                <asp:Image ID="Image1" runat="server" Height="185px" ImageUrl="~/img/agenthome.png" Width="162px" />
            </td>
        </tr>
    </table>
<%--<table>
    <tr>
        <td>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                CellPadding="3" DataSourceID="SqlDataSource1" Width="506px">
                <Columns>
