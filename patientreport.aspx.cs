...
public partial class patientreport : System.Web.UI.Page
{
    ...
    string query, a, patid, treatdate, treattime, docname, docuname, hosname, hosloc, pid, pname, dises, type, symp, medi, descrip, labreport, nurseremark;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
     ...
     //       lblpatdecry.Text=encrypt(rd[0].ToString());
        }
        rd.Close();
        con.Close();
        GridView1.DataBind();
