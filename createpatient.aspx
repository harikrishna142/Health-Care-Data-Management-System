<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="createpatient.aspx.cs" Inherits="createpatient" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
     ...
     <tr>
        ...
        <td class="auto-style2">
            <asp:TextBox ID="txtphone" runat="server" onkeydown="return isNumeric(event.keyCode);" onpaste="return false;" MaxLength="10"></asp:TextBox>
            ...
            <asp:RegularExpressionValidator ID="valMinLength" runat="server" 
                ControlToValidate="txtphone" ErrorMessage="Min 10 digits" ForeColor="Red" 
