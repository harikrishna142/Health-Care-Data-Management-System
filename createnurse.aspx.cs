...
using System.IO;
public partial class createnurse : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    ...
    {
        data();
        query = "select max(id) from nursedet";
        ...
        if (aidd == 0)
        {
            ...
            aidd = 1;
            lblnurseid.Text = "NUR" + aidd.ToString();
        }
        else
        {
            aidd = aidd + 1;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        data();
        query = "insert into nursedet(nurseid,nursename,age,gender,yrexp,phno,email,uname,pwd,actor)values('" + lblnurseid.Text + "','" + txtname.Text + "','" + txtage.Text + "','" + a.ToString() + "','" + txtyrexp.Text + "','" + txtphone.Text + "','" + txtemail.Text + "','" + txtusername.Text + "','" + txtpassword.Text + "','Nurse')";
        cmd = new SqlCommand(query, con);
        cmd.ExecuteNonQuery();
        con.Close();
        classGeneral.ShowMessage("Nurse Created");
        Response.Redirect("createnurse.aspx");
        Medid();
    }
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        data();
        query = "delete from nursedet where nurseid='" + docid + "'";
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        data();
        query = "update nursedet set nursename='" + gtxtname.Text + "',age='" + gtxtage.Text + "',gender='" + gtxtgender.Text + "',yrexp='" + gtxtyrexp.Text + "',phno='" + gtxtphno.Text + "',email='" + gtxtemail.Text + "',uname='" + gtxtusername.Text + "',pwd='" + gtxtpwd.Text + "' where nurseid='" + docid + "'";
