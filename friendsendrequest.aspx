<%@ Page Title="" Language="C#" MasterPageFile="~/Friend.master" AutoEventWireup="true" CodeFile="friendsendrequest.aspx.cs" Inherits="friendsendrequest" %>
     ...
     <tr>
        ...
        <td>
            <asp:DropDownList ID="DropDownList1" runat="server" Font-Bold="True" 
                Font-Names="Times New Roman" AppendDataBoundItems="True"
                DataSourceID="SqlDataSource1" DataTextField="patid" 
                DataValueField="patid">
