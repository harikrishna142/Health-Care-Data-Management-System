...
using System.IO;
using System.Text;
public partial class viewtreatement : System.Web.UI.Page
{
    SqlConnection con;
    ...
    {
        data();
        query = "select tid,date,time,docname,hosname,hosloc,pname,dises,type,symp,medi,descrip from treatment";
